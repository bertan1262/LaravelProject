...
@section('title', 'Ürünü Düzenle: ' . $product->title)
...
<div class="d-flex justify-content-between align-items-center mb-3">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.product.show', $product) }}" class="text-decoration-none">{{ $product->title }}</a></li>
            <li class="breadcrumb-item active">Düzenle</li>
        </ol>
    </nav>
</div>

{{-- @method('PUT') — tarayıcı PUT desteklemediği için Laravel formdan alır --}}
<form action="{{ route('admin.product.update', $product) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="d-flex gap-2 mt-4">
        ...
        <a href="{{ route('admin.product.show', $product) }}" class="btn btn-outline-secondary px-4">
...
<script>
    const { ClassicEditor, Essentials, Bold, Italic, Underline, Strikethrough,
            ...
            Table, TableToolbar, Alignment, FontSize, FontColor } = CKEDITOR;
